...
probejs is a comprehensive static analysis framework for JavaScript that performs vulnerability detection through object property graph generation and symbolic execution.
...
* **Path Feasibility Checking**: Heuristic Z3-based feasibility validation for vulnerable paths
...
5. **Constraint Solving**: Z3 solver performs heuristic path feasibility checking
